...
class UserAdminImport implements ToModel, WithHeadingRow
{
    /**
     * @param array $row
     *
    ...
    public function customValidationMessages()
    {
        ...
        return [
            ...
            'roles.in' => 'Sepertinya Anda salah menginput Nilai :attribute (:input). Harusnya anda menginputkan ADMIN.'
