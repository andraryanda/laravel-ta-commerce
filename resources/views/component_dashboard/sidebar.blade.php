    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
                    ...
                    @if (request()->routeIs('dashboard.bulan.*'))
                        ...
                        <div id="menu4"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                    <x-jet-nav-link class="mb-3" href="{{ route('dashboard.bulan.index') }}"
                                        :active="request()->routeis('dashboard.bulan.index')">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <x-jet-nav-link class="mb-3"
                                        href="{{ route('dashboard.bulan.indexAdminInactive') }}" :active="request()->routeis('dashboard.bulan.indexAdminInactive')">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <span class="ml-3">{{ __('Wifi InActive') }}</span>
                                    </x-jet-nav-link>
                                </li>
                            </ul>
                        </div>
                ...
                <li class="relative px-6 py-3">
                    @if (request()->routeIs('dashboard.bulan.*'))
                        <button onclick="showMenu4(true)"
                            ...
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                id="icon4" class="transform" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd" stroke="currentColor" stroke-width="1.5"
                ...
                <li class="relative px-6 py-3">
                    @if (request()->routeIs('dashboard.chart.*'))
                        <button onclick="showMenu3(true)"
                            ...
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                id="icon3" class="transform" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd" stroke="currentColor" stroke-width="1.5"
            ...
            @elseif (Auth::user()->roles == 'USER')
                ...
                <li class="relative px-6 py-3">
                    @if (request()->routeIs('dashboard.bulan-customer.*'))
                        <button onclick="showMenu4(true)"
                            class="inline-flex items-center justify-between w-full text-sm font-semibold bg-purple-500 text-white px-2 py-2 rounded transition-colors duration-150 hover:text-white hover:bg-purple-700 dark:hover:text-gray-200">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <div id="menu4"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                    <x-jet-nav-link href="{{ route('dashboard.bulan-customer.index') }}"
                                        :active="request()->routeis('dashboard.bulan-customer.index')">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="px-6 my-4">
            <a href="https://wa.me/send?phone=6285314005779" target="_blank" title="Whatsapp Admin"
            ...
            @if (Auth::user()->roles == 'OWNER')
                <li class="relative px-6 py-3">
                    @if (request()->routeis([
                        ...
                        <button onclick="showMenu15(true)"
                            class="inline-flex items-center justify-between w-full text-sm font-semibold bg-purple-500 text-white px-2 py-2 rounded transition-colors duration-150 hover:text-white hover:bg-purple-700 dark:hover:text-gray-200">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                id="icon15" class="transform" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd" stroke="currentColor" stroke-width="1.5"
                        ...
                        <div id="menu15"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                    <x-jet-nav-link href="{{ route('dashboard.carousel.index') }}"
                                        :active="request()->routeIs([
                                            'dashboard.carousel.index',
                                            'dashboard.carousel.edit',
                                        ])">
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                    <x-jet-nav-link href="{{ route('dashboard.contact.index') }}"
                                        :active="request()->routeIs([
                                            'dashboard.contact.index',
                                            'dashboard.contact.edit',
                                        ])">
                    ...
                    @else
                        <button onclick="showMenu15(true)" {{-- class="inline-flex items-center  justify-between w-full text-sm font-semibold  px-2 py-2 rounded transition-colors duration-150 hover:text-gray-800  dark:hover:text-gray-200"> --}}
                            class="inline-flex items-center focus:outline-none justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <div id="menu15"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                    <x-jet-nav-link href="{{ route('dashboard.carousel.index') }}"
                                        :active="request()->routeIs('dashboard.carousel.index')">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="relative px-6 py-3">
                    @if (request()->routeis('dashboard.user*'))
                        <button onclick="showMenu11(true)"
                            ...
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                id="icon11" class="transform" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd" stroke="currentColor" stroke-width="1.5"
                    ...
                    @else
                        <button onclick="showMenu11(true)" {{-- class="inline-flex items-center  justify-between w-full text-sm font-semibold  px-2 py-2 rounded transition-colors duration-150 hover:text-gray-800  dark:hover:text-gray-200"> --}}
                            class="inline-flex items-center focus:outline-none justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <span class="inline-flex items-center">
                                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                ...
                <li class="relative px-6 py-3">
                    @if (request()->routeIs('dashboard.bulan.*'))
                        <button onclick="showMenu14(true)"
                            class="inline-flex items-center justify-between w-full text-sm font-semibold bg-purple-500 text-white px-2 py-2 rounded transition-colors duration-150 hover:text-white hover:bg-purple-700 dark:hover:text-gray-200">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                id="icon14" class="transform" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd" stroke="currentColor" stroke-width="1.5"
                        ...
                        <div id="menu14"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    ...
                                    <x-jet-nav-link class="mb-3"
                                        href="{{ route('dashboard.bulan.indexAdminInactive') }}"
                                        :active="request()->routeis('dashboard.bulan.indexAdminInactive')">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
