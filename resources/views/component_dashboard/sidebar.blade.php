        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeis('dashboard.user*'))
                    <button onclick="showMenu1(true)"
                        ...
                        <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" id="icon1"
                            class="transform" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div id="menu1" class="flex justify-start my-2.5 flex-col w-full md:w-auto items-start pb-1 ">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                <x-jet-nav-link href="{{ route('dashboard.user.indexUserAdmin') }}" :active="request()->routeIs('dashboard.user.indexUserAdmin*')">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('dashboard.transaction.index*'))
                    ...
                    <div id="menu2" class="flex justify-start my-2.5 flex-col w-full md:w-auto items-start pb-1 ">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            x-transition:enter-start="opacity-25 max-h-0"
                            x-transition:enter-end="opacity-100 max-h-xl"
                            class="p-2 mt-2 space-y-2 overflow-hidden w-full text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('dashboard.chart.*'))
                    ...
                    <div id="menu3" class="flex justify-start my-2.5 flex-col w-full md:w-auto items-start pb-1 ">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            x-transition:enter-start="opacity-25 max-h-0"
                            x-transition:enter-end="opacity-100 max-h-xl"
                            class="p-2 mt-2 space-y-2 overflow-hidden w-full text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                <x-jet-nav-link href="{{ route('dashboard.chart.chartUsers') }}" :active="request()->routeis('dashboard.chart.chartUsers')">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @else
                    ...
                    <div id="menu3" class="flex justify-start flex-col w-full md:w-auto items-start pb-1 hidden">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            x-transition:enter-start="opacity-25 max-h-0"
                            x-transition:enter-end="opacity-100 max-h-xl"
                            class="p-2 mt-2 space-y-2 overflow-hidden w-full text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
        ...
        <ul>
            <li class="relative px-6 py-3">
                @if (request()->routeIs('dashboard.user.index*'))
                    ...
                    <div id="menu11" class="flex justify-start my-2.5 flex-col w-full md:w-auto items-start pb-1 ">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            x-transition:enter-start="opacity-25 max-h-0"
                            x-transition:enter-end="opacity-100 max-h-xl"
                            class="p-2 mt-2 space-y-2 overflow-hidden w-full text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
                ...
                @else
                    ...
                    <div id="menu11" class="flex justify-start flex-col w-full md:w-auto items-start pb-1 hidden">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            x-transition:enter-start="opacity-25 max-h-0"
                            x-transition:enter-end="opacity-100 max-h-xl"
                            class="p-2 mt-2 space-y-2 overflow-hidden w-full text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('dashboard.transaction.index*'))
                    <button onclick="showMenu12(true)"
                        ...
                        <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                            id="icon12" class="transform" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                clip-rule="evenodd" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    ...
                    <div id="menu12" class="flex justify-start my-2.5 flex-col w-full md:w-auto items-start pb-1 ">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            x-transition:enter-start="opacity-25 max-h-0"
                            x-transition:enter-end="opacity-100 max-h-xl"
                            class="p-2 mt-2 space-y-2 overflow-hidden w-full text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
            ...
            <li class="relative px-6 py-3">
                <x-jet-nav-link href="{{ route('dashboard.chart.chartVirtualBisnis') }}" :active="request()->routeis('dashboard.chart*')">
                    <svg xmlns="{{ url('http://www.w3.org/2000/svg') }}" class="w-5 h-5" aria-hidden="true"
                        fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
