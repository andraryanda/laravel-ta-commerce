            ...
            <script>
                $(document).ready(function() {
                    ...
                    var table = $('#crudTable').DataTable({
                        ...
                        language: {
                            searchPlaceholder: "Search Data Home",
                            decimal: ',',
                            thousands: '.',
                            paginate: {
                                first: "First",
                ...
                <div class="flex justify-start space-x-2 my-3 mx-3">
                    ...
                    <button data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                        ...
                        <div class="flex items-center">
                            ...
                            <p>Create Landing Page Contact</p>
                        </div>
                    </button>
                </div>
                                ...
                                <form action="{{ route('dashboard.contact.store') }}" method="POST"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input value="{{ old('title_contact') }}" name="title_contact"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <textarea name="description_contact"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="description_contact" type="text" placeholder="Tulis deskripsi">{{ old('description_contact') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <textarea name="address_contact"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="address_contact" type="text" placeholder="Tulis alamat">{{ old('address_contact') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input value="{{ old('phone_contact') }}" name="phone_contact"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input value="{{ old('email_contact') }}" name="email_contact"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
        ...
        @push('javascript')
            <script>
                $('body').on('click', '.edit-button', function() {
                    ...
                    $.ajax({
                        url: "{{ route('dashboard.contact.edit', ['contact' => ':id']) }}".replace(
                            ':id',
                            contact_id),
                        cache: false,
                        type: "GET",
                        success: function(response) {
                            window.location.href =
                                "{{ route('dashboard.contact.edit', ['contact' => ':id']) }}"
                                .replace(':id',
                                    contact_id) + '?_=' + new Date().getTime();
                        },
                        error: function() {
            ...
            <script>
                $(document).ready(function() {
                    $('body').on('click', '.delete-button', function() {
                        var contact_id = $(this).data("id");
                        Swal.fire({
                            title: 'Apakah anda yakin ingin menghapus landing page contact ini?',
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('dashboard.contact.destroy', ':id') }}"
                                        .replace(
                                            ':id', contact_id),
                                    data: {
                                        "_token": "{{ csrf_token() }}"
