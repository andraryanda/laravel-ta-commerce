                ...
                $(document).ready(function() {
                    ...
                    var table = $('#crudTable').DataTable({
                        ...
                        columns: [{
                            ...
                            {
                                data: 'name_people_team',
                                name: 'name_people_team',
                                className: 'dt-body-start',
                            },
                            {
                                data: 'job_people_team',
                                name: 'job_people_team',
                                className: 'dt-body-start',
                            },
                            {
                                data: 'description_people_team',
                                name: 'description_people_team',
                                className: 'dt-body-start',
                            ...
                            {
                                data: 'image_people_team',
                                name: 'image_people_team',
                                className: 'dt-body-start',
                            },
                            {
                                data: 'created_at',
                        ...
                        language: {
                            searchPlaceholder: "Search Data About Team",
                            decimal: ',',
                            thousands: '.',
                            paginate: {
                                first: "First",
                ...
                <div class="flex justify-start space-x-2 my-3 mx-3">
                    ...
                    <button data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                        ...
                        <div class="flex items-center">
                            ...
                            <p>Create Landing Page About Team</p>
                        </div>
                    </button>
                </div>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                    Create Landing Page About Team
                                </h3>
                                <button type="button"
                            ...
                            <div class="p-6 space-y-6">
                                <form action="{{ route('dashboard.about-team.store') }}" method="POST"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            <label
                                                ...
                                                for="name_people_team">
                                                Judul About Team
                                            </label>
                                            <input value="{{ old('name_people_team') }}" name="name_people_team"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="name_people_team" type="text" placeholder="Judul About Team">
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input value="{{ old('job_people_team') }}" name="job_people_team"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="job_people_team" type="text" placeholder="Job About Team">
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            <label
                                                class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                                for="description_people_team">
                                                Deskripsi About Team
                                            </label>
                                            <textarea name="description_people_team"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="description_people_team" type="text" placeholder="Tulis deskripsi">{{ old('description_people_team') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            <label
                                                class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                                for="image_people_team">
                                                Gambar About Team
                                            </label>
                                            <input multiple accept="image/*" value="{{ old('image_people_team') }}"
                                                name="image_people_team"
                ...
                <table id="crudTable" class="w-full row-border whitespace-no-wrap my-2 py-2">
                    <thead>
                        <tr
                            ...
                            <th>No</th>
                            <th>Nama Orang About Team</th>
                            <th>Job About Team</th>
                            <th>Deskripsi Orang About Team</th>
                            <th>Gambar About Team</th>
                            <th>Tanggal</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
        ...
        @push('javascript')
            <script>
                $('body').on('click', '.edit-button', function() {
                    var about_team_id = $(this).data('id');
                    $.ajax({
                        url: "{{ route('dashboard.about-team.edit', ['about_team' => ':id']) }}".replace(':id',
                            about_team_id),
                        cache: false,
                        type: "GET",
                        success: function(response) {
                            window.location.href =
                                "{{ route('dashboard.about-team.edit', ['about_team' => ':id']) }}".replace(
                                    ':id',
                                    about_team_id) + '?_=' + new Date().getTime();
                        },
                        error: function() {
            ...
            <script>
                $(document).ready(function() {
                    $('body').on('click', '.delete-button', function() {
                        var about_team_id = $(this).data("id");
                        Swal.fire({
                            title: 'Apakah anda yakin ingin menghapus landing page about team ini?',
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('dashboard.about-team.destroy', ':id') }}"
                                        .replace(
                                            ':id', about_team_id),
                                    data: {
                                        "_token": "{{ csrf_token() }}"
