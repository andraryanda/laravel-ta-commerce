                ...
                $(document).ready(function() {
                    ...
                    var table = $('#crudTable').DataTable({
                        ...
                        columns: [{
                            ...
                            {
                                data: 'title_about_feature',
                                name: 'title_about_feature',
                                className: 'dt-body-start',
                            },
                            {
                                data: 'description_about_feature',
                                name: 'description_about_feature',
                                className: 'dt-body-start',
                            ...
                            {
                                data: 'image_about_feature',
                                name: 'image_about_feature',
                                className: 'dt-body-start',
                            },
                            {
                                data: 'created_at',
                        ...
                        language: {
                            searchPlaceholder: "Search Data About Feature",
                            decimal: ',',
                            thousands: '.',
                            paginate: {
                                first: "First",
                ...
                <div class="flex justify-start space-x-2 my-3 mx-3">
                    ...
                    <button data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                        ...
                        <div class="flex items-center">
                            ...
                            <p>Create Landing Page About Feature</p>
                        </div>
                    </button>
                </div>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                    Create Landing Page About Feature
                                </h3>
                                <button type="button"
                            ...
                            <div class="p-6 space-y-6">
                                <form action="{{ route('dashboard.about-feature.store') }}" method="POST"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input value="{{ old('title_about_feature') }}" name="title_about_feature"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="title_about_feature" type="text" placeholder="Judul About Feature">
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <textarea name="description_about_feature"
                                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="description_about_feature" type="text" placeholder="Tulis deskripsi">{{ old('description_about_feature') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input multiple accept="image/*" value="{{ old('image_about_feature') }}"
                                                name="image_about_feature"
                ...
                <table id="crudTable" class="w-full row-border whitespace-no-wrap my-2 py-2">
                    <thead>
                        <tr
                            ...
                            <th>No</th>
                            <th>Judul About Feature</th>
                            <th>Deskripsi About Feature</th>
                            <th>Gambar About Feature</th>
                            <th>Tanggal</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
        ...
        @push('javascript')
            <script>
                $('body').on('click', '.edit-button', function() {
                    var about_feature_id = $(this).data('id');
                    $.ajax({
                        url: "{{ route('dashboard.about-feature.edit', ['about_feature' => ':id']) }}".replace(
                            ':id',
                            about_feature_id),
                        cache: false,
                        type: "GET",
                        success: function(response) {
                            window.location.href =
                                "{{ route('dashboard.about-feature.edit', ['about_feature' => ':id']) }}"
                                .replace(
                                    ':id',
                                    about_feature_id) + '?_=' + new Date().getTime();
                        },
                        error: function() {
            ...
            <script>
                $(document).ready(function() {
                    $('body').on('click', '.delete-button', function() {
                        var about_feature_id = $(this).data("id");
                        Swal.fire({
                            title: 'Apakah anda yakin ingin menghapus landing page about feature ini?',
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('dashboard.about-feature.destroy', ':id') }}"
                                        .replace(
                                            ':id', about_feature_id),
                                    data: {
                                        "_token": "{{ csrf_token() }}"
