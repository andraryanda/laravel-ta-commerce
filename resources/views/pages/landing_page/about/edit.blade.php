<x-layout.apps>
    <x-slot name="header">
        <button onclick="window.location.href='{{ route('dashboard.about-utama.index') }}'"
        ...
        <div class="py-3">
            <div
                ...
                <div>
                    ...
                    @endif
                    <form class="w-full" action="{{ route('dashboard.about-utama.update', $landingPageAbout->id) }}"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input value="{{ old('title_about', $landingPageAbout->title_about) }}" name="title_about"
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="title_about" type="text" placeholder="Title About">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <textarea name="description_about"
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="description_about" type="text" placeholder="Tulis deskripsi"
                                    value="{{ $landingPageAbout->description_about }}">{{ old('description_about', $landingPageAbout->description_about) }}</textarea>
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input multiple accept="image/*" name="image_about"
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                    id="file_input" type="file" required>

                                <div class="my-3">
                                    <img id="image_element" src="{{ Storage::url($landingPageAbout->image_about) }}"
