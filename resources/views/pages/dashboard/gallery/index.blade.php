<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <button class="bg-blue-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-lg" onclick="window.location.href='{{ route('dashboard.product.index') }}'">
                    Back
                </button>
            </div>
