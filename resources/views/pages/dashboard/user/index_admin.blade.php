            ...
            <div class="px-3 py-3 overflow-x-auto bg-white sm:p-6">
                <div class="mb-10 mt-3">
                    <a href="{{ route('dashboard.product.create') }}"
                        class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded shadow-lg">
                        + Create User
                    </a>
                    <a href="{{ route('dashboard.user.exportRoleAdmin') }}"
                        class="bg-green-500 hover:bg-green-700 text-white font-bold mx-2 py-2 px-4 rounded shadow-lg">
                        <i class="fa fa-file"></i> Export User Admin
                    </a>
                </div>
