        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class=" overflow-x-auto bg-white">
                <div class="flex justify-start space-x-2 my-3  mx-3">
                    <button type="button" onclick="window.location.href='{{ route('dashboard.user.createUserCustomer') }}'"
                        title="Create"
                    ...
                    <button type="button" @click="openModal" title="Import"
                        ...
                        <div class="flex items-center">
                            ...
                            <p>Import User Customer</p>
                        </div>
                    </button>
                </div>
                <div class="flex justify-start space-x-2 my-3  mx-3">
                    <button type="button" onclick="window.location.href='{{ route('dashboard.report.exportRoleUser') }}'"
                        title="Export"
                ...
                <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                    ...
                    <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div class="mt-4 mb-6">
                            ...
                            <form action="{{ route('dashboard.user.importUserCustomer') }}" method="POST"
