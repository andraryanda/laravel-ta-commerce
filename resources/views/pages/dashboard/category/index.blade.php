            ...
            <script>
                $(document).ready(function() {
                    ...
                    var table = $('#crudTable').DataTable({
                        ...
                        language: {
                            searchPlaceholder: "Search Data Kategori",
                            decimal: ',',
                            thousands: '.',
                            paginate: {
                                first: "First",
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="overflow-x-auto bg-white ">
                <div class="flex justify-start space-x-2 my-3 mx-3">
                    <button type="button" onclick="window.location.href='{{ route('dashboard.category.create') }}'"
                        title="Create"
                ...
                <div class="flex justify-start space-x-2 my-3 mx-3">
                    <button type="button"
                        onclick="window.location.href='{{ route('dashboard.report.exportProductCategories') }}'"
                        title="Export"
